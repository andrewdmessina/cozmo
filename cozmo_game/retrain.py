...
from take_pictures import take_pictures as take_pictures
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      default='',
      help="""\
      The new object we are training for.  If this is not set then
      the script will assume that the images are already setup and 
      there is no need for Cozmo to take more pictures.

      In order to use this properly, specify the object name, ie 
      "red_block". Do not use whitespace characters as those will cause 
      the script to break when it makes the directory.

      Make sure Cozmo is pointed at the object you want to use for taining
      and then let him see it from every angle that he might encouter the 
      object as this will provide optimal results.
      """
  )
  parser.add_argument(
      '--image_dir',
